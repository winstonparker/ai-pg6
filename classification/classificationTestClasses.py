...
def readDigitData(trainingSize=100, testSize=100):
    ...
    rawTestData = samples.loadDataFile("data/digitdata/testimages", testSize,DIGIT_DATUM_WIDTH,DIGIT_DATUM_HEIGHT)
    testLabels = samples.loadLabelsFile("data/digitdata/testlabels", testSize)
    try:
